 ...
 */
final class Version20230922155037 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invitations_user (invitations_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_CC13F73EA76ED395 (user_id), INDEX IDX_CC13F73E5A6F1243 (invitations_id), PRIMARY KEY(invitations_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
